...
void nextImage::setGame(sliderPz* inPtr) { ourGame = inPtr; }
...
void scramble::setGame(sliderPz* inPtr) { ourGame = inPtr; }
...
sliderPz::sliderPz(int ourAppID)
  : panel(ourAppID) {
...
sliderPz::~sliderPz(void) { if (ourCardDeck) delete(ourCardDeck); }





void sliderPz::setup(void) {
...
bool sliderPz::setImagePath(void) {
...
void sliderPz::doScramble(void) { ourBoard->scramble(); }


void sliderPz::loop(void) { }


void sliderPz::closing(void) {  }
